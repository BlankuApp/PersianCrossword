...
4. برای هماهنگ‌کردن فرمت، فایل‌های موجود در پوشه‌ی `puzzles/` را به‌عنوان نمونه بررسی کنید.
5. در صورت نیاز، با اجرای تسک `Run App Dev Server (LAN)` یا ابزارهای پروژه، نتیجه را بررسی و اصلاح کنید.
